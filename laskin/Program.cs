...
switch (lasku) {
    case 1:
        ...
        Console.WriteLine($"summa on: {Kertolasku(luku1, luku2)}");            // Käyttäjä syöttää luvun 1 ja 2, sitten laskin laskee ne yhteen ja tulostaa lopputuloksen.  Lasku tapahtuu double- muuttujalla.
        break;
